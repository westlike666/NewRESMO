...
%infintesmall volume dV=sin(phi) r^2 dr d_phi d_theta

V=sin(phi)*2*pi.*r.^3/3;  % dV =abc*r^2*sin(phi)*d_phi*d_theta*dr: integrate over dr from 0 to r and d_theta from 0 to 2pi
