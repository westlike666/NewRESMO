...
clear; clc;close all
tosave=true;
for density=[0.005 0.008]   % in unit um^-3, which is 10^12*cm^-3
    tic
    ...
    sigma_x=1*1000;
    sigma_y=0.55*1000;  %
    sigma_z=0.7*1000;  % Gaussian width convert from mm to um defualt 0.42
...
%     sigma_x=0.70*1000;
    ...
    foldername=['SOC_R_PQN_',num2str(n),'othertry'];
    mkdir(foldername);
